...
function SamplePrevArrow(props) {
    ...
    return (
        <div
            className={className}
            style={window.innerWidth > 450 ? { ...style, display: "flex", alignItems: "center", justifyContent: "center", background: "var(--secondary-color)", borderRadius: "100%", width: "30px", height: "30px" } : { display: "none" }}
            onClick={onClick}
...
const ProductContainer = () => {
    ...
    const getProductVariants = (product) => {
        return product.variants.map((variant, ind) => (
            <option key={ind} value={JSON.stringify(variant)} className="options_class" >
                                                            ...
                                                            <div className='product-card'  >
                                                                ...
                                                                <div className="card-body product-card-body p-3" >
                                                                    ...
                                                                    <div className='price'>
                                                                        ...
                                                                        <span id={`price${index}${index0}-section`} className="d-flex align-items-center"><p id='fa-rupee' className='m-0'><FaRupeeSign fill='var(--secondary-color)' /></p> {product.variants[0].price}</span>

                                                                    </div>
                                                                    <div className='product_varients_drop'>
                                                                        {product.variants.length > 1 ? <>

                                                                            <select style={{ fontSize: "8px !important" }} className='form-select variant_selection select-arrow' id={`select-product${index}${index0}-variant-section`} onChange={(e) => {
                                                                                document.getElementById(`price${index}${index0}-section`).innerHTML = document.getElementById('fa-rupee').outerHTML + parseFloat(JSON.parse(e.target.value).price);
                                                                            ...
                                                                            <>
                                                                            <input type="hidden" name="" id={`select-product${index}${index0}-variant-section`} value={JSON.stringify(product.variants[0])} />
                                                                                {/* <span className='variant_value select-arrow' id=''>{product.variants[0].measurement + " " + product.variants[0].stock_unit_name}
                                                                                </span> */}
                                                                                <span className='variant_value select-arrow' id=''>{product.variants[0].stock_unit_name}
                                                                                </span>
                                                                            </>}
                                                                ...
                                                                <div className='d-flex flex-row border-top product-card-footer'>
                                                                    ...
                                                                    <div className='dropup share'>
                                                                        ...
                                                                        <ul className='dropdown-menu'>
                                                                            <li className='dropDownLi'><WhatsappShareButton url={`${share_url}/product/${product.slug}`}><WhatsappIcon size={32} round={true} /> <span>WhatsApp</span></WhatsappShareButton></li>
                                                                            <li className='dropDownLi'><TelegramShareButton url={`${share_url}/product/${product.slug}`}><TelegramIcon size={32} round={true} /> <span>Telegram</span></TelegramShareButton></li>
                                                                            <li className='dropDownLi'><FacebookShareButton url={`${share_url}/product/${product.slug}`}><FacebookIcon size={32} round={true} /> <span>Facebook</span></FacebookShareButton></li>
                                                                            <li>
                                                                                <button type='button' onClick={() => {
                                                                                    navigator.clipboard.writeText(`${share_url}/product/${product.slug}`)
