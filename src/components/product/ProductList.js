      ...
      >
        <div className="row" id="products">
          ...
          >
            ...
            <ProductFilter category={category} closeCanvas={closeCanvas} brands={brands} setcurrPage={setcurrPage} setoffset={setoffset} minmaxTotalPrice={minmaxTotalPrice} brandproductcountmap={brandproductcountmap} />
          </div>
