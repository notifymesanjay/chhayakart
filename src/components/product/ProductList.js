...
const ProductList = () => {
    ...
    const getProductVariants = (product) => {
        ...
        return product.variants.map((variant, ind) => (
            <option key={ind} value={CryptoJS.AES.encrypt(
                                                ...
                                                <div className='h-100 productList_content'>
                                                    <div className="row flex-wrap">
                                                        {productresult.map((product, index) => (
                                                            <div key={index} className={`${!filter.grid_view ? 'col-12 list-view ' : 'col-md-4 col-lg-3 '}`}>
                                                                <div className={`product-card my-3 ${filter.grid_view ? "flex-column " : "my-3"}`}>
                                                                            ...
                                                                            <div className='d-flex flex-row border-top product-card-footer'>
                                                                                ...
                                                                                <div className='border-end' style={{ flexGrow: "1" }} >
                                                                                    <button type="button" id={`Add-to-cart-section${index}`} className='w-100 h-100 add-to-cart active' onClick={() => {
                                                                                        if (cookies.get('jwt_token') !== undefined) {
                                                                                            ...
                                                                                            addtoCart(product.id, product.variants.length > 1 ? JSON.parse(document.getElementById(`select-product${index}-variant-section`).value).id : JSON.parse(document.getElementById(`default-product${index}-variant-id
                                                                                            `).value), document.getElementById(`input-section${index}`).innerHTML)
                                                                                        }
                                                                                        else {
                                                                                ...
                                                                                <div className='dropup share'>
                                                                                    ...
                                                                                    <ul className='dropdown-menu'>
                                                                                        <li><WhatsappShareButton url={`https://chhayakart.com/product/${product.slug}`}><WhatsappIcon size={32} round={true} /> <span>WhatsApp</span></WhatsappShareButton></li>
                                                                                        <li><TelegramShareButton url={`https://chhayakart.com/product/${product.slug}`}><TelegramIcon size={32} round={true} /> <span>Telegram</span></TelegramShareButton></li>
                                                                                        <li><FacebookShareButton url={`https://chhayakart.com/product/${product.slug}`}><FacebookIcon size={32} round={true} /> <span>Facebook</span></FacebookShareButton></li>
                                                                                        <li>
                                                                                            <button type='button' onClick={() => {
                                                                                                navigator.clipboard.writeText(`https://chhayakart.com/product/${product.slug}`)
                                                                    ...
                                                                    <div className="card-body product-card-body p-3" >
                                                                        ...
                                                                        <div className='price'>
                                                                            ...
                                                                            {filter.grid_view ? <>
                                                                                <span id={`price${index}-section`} className="d-flex align-items-center"><p id='fa-rupee'><FaRupeeSign fill='var(--secondary-color)' /></p> {product.variants[0].price}</span>
                                                                                <div className='product_varients_drop'>
                                                                                    {product.variants.length > 1 ? <>
                                                                                        ...
                                                                                        <select style={{ fontSize: "8px !important" }} className='form-select variant_selection select-arrow' id={`select-product${index}-variant-section`} onChange={(e) => {
                                                                                            ...
                                                                                            document.getElementById(`price${index}-section`).innerHTML = document.getElementById('fa-rupee').outerHTML + JSON.parse((CryptoJS.AES.decrypt(e.target.value, secret_key).toString(CryptoJS.enc.Utf8))).price//parseFloat(JSON.parse(e.target.value).price);
                                                                                        ...
                                                                                        <>
                                                                                            <input type="hidden" name={`default-product${index}-variant-id`} id={`default-product${index}-variant-id`} value={product.variants[0].id} />
                                                                                ...
                                                                                <div className='product_varients_drop d-flex align-items-center'>
                                                                                    {product.variants.length > 1 ? <>
                                                                                        ...
                                                                                        <select style={{ fontSize: "8px !important" }} className='form-select variant_selection select-arrow' id={`select-product${index}-variant-section`} onChange={(e) => {
                                                                                            document.getElementById(`price${index}-section`).innerHTML = document.getElementById('fa-rupee').outerHTML + JSON.parse((CryptoJS.AES.decrypt(e.target.value, secret_key).toString(CryptoJS.enc.Utf8))).price;
                                                                            ...
                                                                            <div className='border-end' style={{ flexGrow: "1" }} >
                                                                                <button type="button" id={`Add-to-cart-section${index}`} className='w-100 h-100 add-to-cart active' onClick={() => {
                                                                                    if (cookies.get('jwt_token') !== undefined) {
                                                                                        ...
                                                                                        document.getElementById(`input-cart-section${index}`).classList.add('active')
                                                                                        document.getElementById(`input-section${index}`).innerHTML = 1
                                                                                        addtoCart(product.id, (product.variants.length > 1 ? (JSON.parse(CryptoJS.AES.decrypt(document.getElementById(`select-product${index}-variant-section`).value, secret_key).toString(CryptoJS.enc.Utf8)).id) : document.getElementById(`default-product${index}-variant-id`).value), document.getElementById(`input-section${index}`).innerHTML)
                                                                                    }
                                                                                    else {
                                                                                        toast.error("OOps! You need to login first to access the cart!")
                                                                                    }
                                                                                ...
                                                                                <div id={`input-cart-section${index}`} className="w-100 h-100 input-to-cart" >
                                                                                    <button type='button' onClick={() => {
                                                                                        ...
                                                                                        if (val === 1) {
                                                                                            ...
                                                                                            document.getElementById(`input-cart-section${index}`).classList.remove('active')
                                                                                            document.getElementById(`Add-to-cart-section${index}`).classList.add('active')
                                                                                            removefromCart(product.id, (product.variants.length > 1 ? (JSON.parse(CryptoJS.AES.decrypt(document.getElementById(`select-product${index}-variant-section`).value, secret_key).toString(CryptoJS.enc.Utf8)).id) : document.getElementById(`default-product${index}-variant-id`).value))
