...
const ProductList = ({productTriggered, setProductTriggered = () => {}}) => {
  ...
  const handleAddToCart2 = (product, index) => {
    if (cookies.get("jwt_token") !== undefined) {
      document
        .getElementById(`Add-to-cart-section${index}`)
        .classList.remove("active");
  ...
  const handleDecrement2 = (product, index) => {
    var val = parseInt(
      document.getElementById(`input-section${index}`).innerHTML
    );
    if (cookies.get("jwt_token") !== undefined) {
  ...
  const handleIncrement2 = (product, index) => {
                                  ...
                                  <div className="d-flex flex-row border-top product-card-footer">
                                    ...
                                    >
                                      <button
                                        ...
                                        className="w-100 h-100 add-to-cart active"
                                        onClick={() => {
                                          handleAddToCart2(product, index);
                                        }}
                                      >
                                        add to cart
                                      </button>
                                      ...
                                      >
                                        <button
                                          type="button"
                                          onClick={() => {
                                            handleDecrement2(product, index);
                                          }}
                                        >
                                          <BiMinus />
                                        </button>
                                        ...
                                        <button
                                          type="button"
                                          onClick={() => {
                                            handleIncrement2(product, index);
                                          }}
                                        >
                                          <BsPlus />{" "}
                                        </button>
