                        ...
                        <div className="row category_section_header">
                            <div className="col-md-12 col-12 d-flex justify-content-between align-items-center p-0">
                                <div className="title d-md-flex align-items-center ">
                                    ...
                                    <Link className='d-none d-md-block' to='/categories'>See all categories<AiOutlineArrowRight size={15} /> </Link>
                                </div>
                                <div className=' d-md-none'>
                                    <Link className='category_button' to='/products'>see all</Link>
                                </div>
...

                                    {
                                        shop.shop.category.map((ctg, index) => (
                                            <div className="col-md-12"   key={index} >
                                                ...
                                                <div className='category-container ' style={{padding:"1%"}}>

                                                    {ctg.has_child
                                                        ? (
                                                            <Card onClick={() => selectCategory(ctg)}>
                                                                <Card.Img variant='top'  src={ctg.image_url} alt={ctg.subtitle} className='card-img-top category_image img-fluid' />
